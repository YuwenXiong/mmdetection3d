...
db_sampler = dict(
    ...
    points_loader=dict(
        type="LoadPointsFromFile", coord_type="LIDAR", load_dim=6, use_dim=[0, 1, 2], file_client_args=file_client_args
    ),
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + "waymo_car_bottom_infos_train.pkl",
            # split="training",
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + "waymo_car_bottom_infos_val.pkl",
        # split="training",
